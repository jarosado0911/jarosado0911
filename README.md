...
**Languages and Tools:**  
[![My Skills](https://skillicons.dev/icons?i=matlab,powershell,cmake,c,cpp,cs,unity,md,lua,apple,sklearn,eclipse,html,elasticsearch,ubuntu,python,tensorflow,pytorch,vim,latex,bash,bitbucket,git,github,gitlab,linux,redhat,visualstudio,anaconda&perline=12)](#)
___
